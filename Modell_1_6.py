...
.icon-box:hover {
    ...
    filter: drop-shadow(0px 4px 10px rgba(124, 58, 237, 0.25));
}
...
eingabe_spalte, ergebnis_spalte = st.columns([0.78, 1.22], gap="large")
...
with eingabe_spalte:
    ...
    with st.container(border=True):
        ...
        # -------------------------
        # Reihe 1: Startwert + Aktienquote
        # -------------------------
        r1_icon1, r1_input1, r1_icon2, r1_input2 = st.columns([0.12, 0.38, 0.12, 0.38])
        ...
        # -------------------------
        # Reihe 2: Aktienrendite + Anleihenrendite
        # -------------------------
        r2_icon1, r2_input1, r2_icon2, r2_input2 = st.columns([0.12, 0.38, 0.12, 0.38])

        with r2_icon1:
            icon_box("📈", "#22c55e")
        with r2_input1:
            aktienrendite_prozent = st.number_input(
                "Reale Aktienrendite (% p.a.)",
                min_value=-20.0,
                max_value=30.0,
                value=7.0,
                step=0.5
        ...
        # -------------------------
        # Reihe 3: Zeitraum + Simulationen
        # -------------------------
        r3_icon1, r3_input1, r3_icon2, r3_input2 = st.columns([0.12, 0.38, 0.12, 0.38])
        ...
        st.markdown(
            ...
            Alle Renditen sind real, also nach Inflation. Die Ergebnisse zeigen Kaufkraft in heutigen Euro.
            </div>
            """,
            unsafe_allow_html=True
        )
